                        ...
                        <div class="card-content">
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group label-floating is-empty">
                                            ...
                                            <input type="text" class="form-control" disabled id="txtTotal"
                                                   name="txtTotal">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group label-floating is-empty">
                                            <label class="control-label"></label>
                                            <input type="text" class="form-control" disabled id="txtAvg"
                                                   name="txtAvg">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row" style="padding-top: 50px">
                                <div class="form-horizontal">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group label-floating is-empty">
                                            <label class="control-label"></label>
                                            <input type="number" class="form-control" name="txtCount" value="0">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row" style="padding-top: 50px">
                                <div class="form-horizontal">
                                    ...
                                    <div class="col-sm-10"><input class="form-control" id="txtMarks" type="number"
                                                                  style="font-size: 18px"
                                                                  value="0"></div>
                                    <!--                                        <div class="col-sm-2">-->
                                    <!--                                            <button type="button" class="btn btn-fill" id="setMarks"-->
